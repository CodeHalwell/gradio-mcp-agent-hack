"""CodeRunnerAgent - Executes code in Modal sandboxes with enhanced security."""
...
from mcp_hub.config import app_config
...
try:
    ...
    from mcp_hub.reliability_utils import rate_limited
except ImportError:
...
"""
    ...
    @track_performance(operation_name="sync_code_execution")
    @rate_limited("modal")
